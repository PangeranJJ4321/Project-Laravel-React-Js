            ...
            <section id="Details" className="relative flex max-w-[1130px] mx-auto gap-[30px] mb-20 z-10">
                <div className="flex flex-col w-full rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="font-extrabold text-[32px] leading-[44px]">Angga Park Central <br/> Master Capitalize</h1>
                    ...
                    <p className="leading-[30px]">Whether you need quite private space away from the distractions of an at-times chaotic home office, you’re on a team that needs to brainstorm and collaborate in person, or you’re owner meeting with prospective hires, clients, and partners, having access to hundreds of workspaces can be a game-changing resource.</p>
                    ...
                    <div className="overflow-hidden w-full h-[280px]">
                        <div id="my-map-display" className="h-full w-full max-w-[none] bg-none">
                            <iframe className="h-full w-full border-0" src="https://www.google.com/maps/embed/v1/place?q=Xicheng+District,+Beijing,&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
                        </div>
