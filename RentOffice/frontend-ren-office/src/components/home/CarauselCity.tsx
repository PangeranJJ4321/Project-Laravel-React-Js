    ...
    return (
        <section id="Cities" className="flex flex-col gap-[30px] mt-[100px]">
            <div className="w-full max-w-[1130px] mx-auto flex items-center justify-between">
                <h2 className="font-bold text-[32px] leading-[48px] text-nowrap">You Can Choose <br/>Our Favorite Cities</h2>
            ...
            <div className="swiper w-full">
                <div className="swiper-wrapper">
                    <Swiper direction = 'horizontal' spaceBetween = {20} slidesPerView = "auto" slidesOffsetAfter = {20} slidesOffsetBefore = {20} >                 
