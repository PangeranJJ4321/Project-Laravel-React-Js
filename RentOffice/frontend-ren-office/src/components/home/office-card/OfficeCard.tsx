import { baseURL, Office } from "../../../types/Type";
                ...
                <div className="card-detail-container flex flex-col p-5 pb-[30px] gap-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-[6px]">
                            ...
                            <img src="/assets/images/icons/clock.svg" className="w-6 h-6" alt="clock icon" />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-[6px]">
                            <img src="/assets/images/icons/location.svg" className="w-6 h-6" alt="location icon" />
                            <p className="font-semibold">{office.city.name}
                            </p>
                        </div>
                        <div className="flex items-center gap-[6px]">
                            <p className="font-semibold">4.5/5</p>
                            <img src="/assets/images/icons/Star 1.svg" className="w-6 h-6" alt="star icon" />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-[6px]">
                            <img src="/assets/images/icons/wifi.svg" className="w-6 h-6" alt="wifi icon" />
                            <p className="font-semibold">Fast-Connection</p>
                        </div>
                        <div className="flex items-center gap-[6px]">
                            <img src="/assets/images/icons/security-user.svg" className="w-6 h-6" alt="security icon" />
