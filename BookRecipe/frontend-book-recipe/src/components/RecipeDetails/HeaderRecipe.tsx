            ...
            <div className="absolute bottom-0 w-full flex flex-col gap-5 z-20">
                ...
                <div className="flex justify-between p-5 pb-[23px] gap-3">
                    <div className="flex flex-col gap-[6px]">
                        <p className="font-semibold text-[#FF4C1C]">{recipe?.category.name || "Uncategorized"}</p>
                        <h1 className="font-bold text-[34px] leading-[46px] text-white">{recipe?.name || "Unknown Recipe"}</h1>
                    </div>
